...
export function buildStaticColliders(
  ...
  root.traverse((obj) => {
    ...
    // Map-editor exports contain neither skinned nor instanced meshes; ignore them if they appear.
 ...
 * Written by hand rather than `clone().applyMatrix4()` because the map editor GLBs use
