 ...
 * GLB → MapData (W1-A).
 *
 * Works for the map editor exports (levels/zones/spawns/doors from glTF extras) and for a plain GLB from
...
export interface LoadMapOptions {
  name?: string
  /**
   * Merge the visible static meshes by material into one mesh each (default true). Map-editor keeps
   ...
   * Map-editor exports the lot as a 30 m
...
/**
 * Roughness floor for non-metals (W5-C). Map-editor exports textured surfaces at roughness 0.5,
...
/** A very large, flat mesh in world space: The editor's 30 m lot, not a floor slab or a wall. */
