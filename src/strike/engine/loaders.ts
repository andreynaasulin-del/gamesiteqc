 ...
 *
 * Map-editor exports use EXT_meshopt_compression, KHR_mesh_quantization and KHR_texture_basisu,
...
export function createLoaders(renderer: WebGPURenderer): Loaders {
  const ktx2 = new KTX2Loader().setTranscoderPath(assetUrl('decoders/')).detectSupport(renderer)
