 ...
 * matters, because a map-editor lawn is nearly white and blows out first.
 */
...
/** Half-extent of the sun's shadow frustum, in metres. A the map editor house fits in 16 m. */
