/**
 * `?dev=ui` — the whole interface driven by fake data, so the HUD can be designed (and
 * reviewed) without a renderer, a map or a running match.
 */
import { MATCH, PLAYER, WEAPON } from '../config'
...
const FAKE_NAMES = ['Ace', 'Nina', 'Ozan', 'Pixel', 'Voxel', 'Bezier']
