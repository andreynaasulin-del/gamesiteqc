...
export interface TestRoom {
  ...
  root: Group
  /**
   * A door leaf that is NOT in the static collider — the stand-in for a map-editor openable, which
...
export function buildTestRoomGeometry(): TestRoom {
  ...
  // Two steps under a map-editor height ceiling (soffit 2.48 m): from the upper one a 1.75 m
